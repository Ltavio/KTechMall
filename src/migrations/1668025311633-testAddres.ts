...
export class testAddres1668025311633 implements MigrationInterface {
    name = 'testAddres1668025311633'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "delivery" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "address_id" character varying(100) NOT NULL, "delivery" boolean NOT NULL DEFAULT true, "receiver" character varying(100) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "adressId" uuid, CONSTRAINT "REL_fedd2825b8eeac8facd01f965c" UNIQUE ("adressId"), CONSTRAINT "PK_ffad7bf84e68716cd9af89003b0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "delivery" ADD CONSTRAINT "FK_fedd2825b8eeac8facd01f965cc" FOREIGN KEY ("adressId") REFERENCES "Addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "delivery" DROP CONSTRAINT "FK_fedd2825b8eeac8facd01f965cc"`);
