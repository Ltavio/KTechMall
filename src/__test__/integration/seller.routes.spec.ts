...
import { mockedSellerRequest, mockedSellerUpdate } from "../mocks/sellers";
...
describe("/sellers", () => {
  ...
  test("POST /sellers - Should NOT be able to create seller without authentication", async () => {
    const response = await request(app).post("/sellers").send(mockedSellerRequest);
  ...
  test("GET /sellers - Should NOT be able to list seller without authentication", async () => {
    const response = await request(app).get("/sellers").send(mockedSellerRequest);
  ...
  test("PATCH /sellers - Should NOT be able to updated seller without authentication", async () => {
    const response = await request(app).patch("/sellers").send(mockedSellerRequest);
